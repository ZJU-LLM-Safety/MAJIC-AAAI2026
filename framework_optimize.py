...
demo_item_list = get_prompts("./data/harmful_behaviors_custom_26_50.json")
...
for item in tqdm(demo_item_list):
    ...
    second_score,second_disguised_prompt,second_victim_response = emoji_method(harmful_prompt,attacker_pipe,attacker_tokenizer,victim_pipe,victim_tokenizer,judgetype,5)
    ...
    third_score,third_disguised_prompt,third_victim_response = hypo_method(harmful_prompt,attacker_pipe,attacker_tokenizer,victim_pipe,victim_tokenizer,judgetype,5)
...
with open("./results/results_gpt4o_framework_break_26_50.json", 'w') as file:
