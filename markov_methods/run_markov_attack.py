...
if __name__ == '__main__':
    for victim_model_name in ['gemma-2-9b-it', 'llama3.1-8b-it', 'qwen2.5-7B-Instruct']:
        victim_model_id = f"/hub/huggingface/models/jbmodels/{victim_model_name}"
        ...
        outputfile_name = f'markov_test_literary_222_{victim_model_name}.json'
